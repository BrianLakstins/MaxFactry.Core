// <copyright file="IMaxValidationLibraryProvider.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Core
{
	...
	/// <summary>
    /// Defines the interface for MaxValidationLibrary
	/// </summary>
    public interface IMaxValidationLibraryProvider : IMaxProvider
    {
        /// <summary>
        ...
        string GetValidationError(string lsValidation, object loValue);
    }
}
