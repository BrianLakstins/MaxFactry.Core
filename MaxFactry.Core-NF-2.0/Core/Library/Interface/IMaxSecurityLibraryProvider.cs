// <copyright file="IMaxSecurityLibraryProvider.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Core
{
	...
	/// </summary>
    public interface IMaxSecurityLibraryProvider : IMaxProvider
    {
        /// <summary>
        ...
        /// <returns></returns>
		string GetAccessToken(Uri loTokenUrl, MaxIndex loCredentialIndex);
    }
}
